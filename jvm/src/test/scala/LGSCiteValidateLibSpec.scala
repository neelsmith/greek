...
*/
  ...
  it should "validate a text corpus" in pending /*{
  ...
  it should "apply the validate method of the CiteValidator trait to a physical surface" in pending /*{
  ...
  it should "validate the contents of a CitableNode" in pending /* {
  ...
  it should "identify invalid tokens" in pending /* {
    val urn = CtsUrn("urn:cts:greekLit:tlg0012.tlg001.msA:1.1")
  ...
  it should "find LGS tokens for a surface in the corpus" in pending /*{
  ...
  it should "find LGS tokens for a CTS URN reference in the corpus" in pending /* {
    val urn = CtsUrn("urn:cts:greekLit:tlg0012.tlg001.msB:23.1")
    val tkns = lgsv.tokensForUrn(urn)
  //  println(tkns)
}*/
  it should "generate a verify document for a surface" in pending  /*{
    val page = Cite2Urn("urn:cite2:hmt:msB.v1:303r")
